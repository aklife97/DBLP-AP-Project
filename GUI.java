...
public class GUI
{
	...
	public void runFrame()
	{
		...
		sidePanel.setPreferredSize(new Dimension(250,440));
		sidePanel.setMinimumSize(new Dimension(250,440));
		sidePanel.setMaximumSize(new Dimension(250,440));
		sidePanel.setLocation(0,80);
		sidePanel.setLayout(null);
		sidePanel.setBorder(BorderFactory.createLineBorder(Color.black,2));
		sidePanel.setBackground(Color.WHITE);
		displayPanel.setPreferredSize(new Dimension(950,440));
		displayPanel.setMinimumSize(new Dimension(950,440));
		displayPanel.setMaximumSize(new Dimension(950,440));
		displayPanel.setLocation(250,80);
		displayPanel.setLayout(null);
		displayPanel.setBorder(BorderFactory.createLineBorder(Color.black,2));
		displayPanel.setBackground(Color.WHITE);
		upperPanel=new JPanel();
		upperPanel.setSize(new Dimension(1200,80));
		upperPanel.setMinimumSize(new Dimension(1200,80));
		upperPanel.setMaximumSize(new Dimension(1200,80));
	...
	public void initframe()
	{
		...
		sidePanel.setBounds(0,80,250,440);
		upperPanel.setBounds(0,0,1200,80);
		displayPanel.setBounds(250,80,950,440);
